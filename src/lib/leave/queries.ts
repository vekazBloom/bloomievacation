...
export const leaveRequestWithUserSelect = `*, ${leaveRequestUserEmbed}(name, email), ${leaveRequestBalanceProjectEmbed}, ${leaveRequestGrantAllocationsEmbed}`;

export const leaveRequestWithUserAvatarSelect = `*, ${leaveRequestUserEmbed}(name, email, avatar_url), ${leaveRequestBalanceProjectEmbed}, ${leaveRequestGrantAllocationsEmbed}`;
