...
export default async function NewLeaveRequestPage({ params }: { params: { slug: string } }) {
      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,420px)_minmax(0,1fr)]">
        <Card>
          <CardContent className="p-6">
            <LeaveRequestForm projectId={projectId} projectSlug={project.slug} />
          </CardContent>
        </Card>
        ...
        <div className="space-y-3">
          ...
          <TeamScheduler events={events} members={schedulerMembers} projectSlug={project.slug} />
        </div>
      </div>
    </div>
  );
